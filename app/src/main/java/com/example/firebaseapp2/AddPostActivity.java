    ...
    private void sendPostNotification(JSONObject notificationJo) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest("https://fcm.googleapis.com/fcm/send", notificationJo,
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                headers.put("Authorization", "key=AAAA_ESmqNw:APA91bFQI_TCzMhKGq2wuX7UFK-V9rxZh2_Db6O3P87WybjvRIt5olovm-67QpDV64N-eTOrTOTAHx-RixyCqSkW5Hh5ZSecjB_voOrAJqusLfoXhlOc6uyxCCEs82D396XraHWQd7qN");//paste your fcm key here after "key="
